                    ...
                    switch (subop) {
                        ...
                        case 4:{//Mostrar lista de grupos
                            ...
                            while(llaves.hasMoreElements()) { //mientras no este vació
                                Integer key = llaves.nextElement(); //como si fuera un foreach
                                ArrayList<Grupo> temp = grupos.get(key);    // Obtiene la lista de grupos por materia
                                Grupo materia = temp.get(j);
                                materia.getAsignatura().mostrarAsignatura(); // Muestra la información de la materia de los grupos a mostrar
